...
const Header = ({ basket }) => (
  <div className={styles.wrapper}>
    <ul className={styles.list}>
      ...
      <li className={styles.item}>
        <NavLink exact to="/catalog" className={styles.link} activeClassName={styles.active}>Каталог</NavLink>
      </li>
      <li className={styles.item}>
        <NavLink exact to="/basket" className={styles.link} activeClassName={styles.active}>
